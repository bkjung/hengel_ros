...
class HengelGlobalMap():
    def __init__(self):
        ...
        self.robot_view_publisher = rospy.Publisher(
            '/predict_robot_view', Image, queue_size=10)
        ...
        self.c.create_polygon(
            int(x_px - 75.5 * cos(self.th)),
            int(y_px + 75.5 * sin(self.th)),
            int(x_px - 58 * cos(self.th)),
            int(y_px + 58 * sin(self.th)),
            int(x_px - 29 * cos(self.th) + 25 * sin(self.th)),
            int(y_px + 29 * sin(self.th) + 25 * cos(self.th)),
            int(x_px + 29 * cos(self.th) + 25 * sin(self.th)),
            int(y_px - 29 * sin(self.th) + 25 * cos(self.th)),
            int(x_px + 58 * cos(self.th)),
            int(y_px - 58 * sin(self.th)),
            int(x_px + 75.5 * cos(self.th)),
            int(y_px - 75.5 * sin(self.th)),
            int(x_px + 75.5 * cos(self.th) + 111 * sin(self.th)),
            int(y_px - 75.5 * sin(self.th) + 111 * cos(self.th)),
            int(x_px - 75.5 * cos(self.th) + 111 * sin(self.th)),
            int(y_px + 75.5 * sin(self.th) + 111 * cos(self.th)),
            outline='red',
            fill='',
