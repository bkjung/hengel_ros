...
def calibration(_image, board_w, board_h,
                n_board):  #n_board: required num of views
    successes = 0
    ...
    ret, mtx, dist, rvecs, tves = cv2.calibrateCamera(
        obj_pnts, img_pnts, gray.shape[::-1], None, None)
