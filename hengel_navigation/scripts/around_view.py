...
class AroundImage:
    ...
    def Initialize(self):
        ...
        self.cam_front.set(CV_CAP_PROP_BUFFERSIZE, 1)
        ...
        self.cam_left.set(CV_CAP_PROP_BUFFERSIZE, 1)
        ...
        self.cam_right.set(CV_CAP_PROP_BUFFERSIZE, 1)
        ...
        self.homography_front=cv2.getPerspectiveTransform(imgPts[0], objPts[0])
        self.homography_left= cv2.getPerspectiveTransform(imgPts[1], objPts[1])
        self.homography_right=cv2.getPerspectiveTransform(imgPts[2], objPts[2])
